...
(function (factory) {
	...
	$.fn.perfectScrollbar = function (suppliedSettings, option) {
		return this.each(function () {
			...
			var $scrollbarXRail = $(
					"<div class='ps-scrollbar-x-rail'></div>",
				).appendTo($this),
				$scrollbarYRail = $("<div class='ps-scrollbar-y-rail'></div>").appendTo(
					$this,
				),
				$scrollbarX = $("<div class='ps-scrollbar-x'></div>").appendTo(
					$scrollbarXRail,
				),
				$scrollbarY = $("<div class='ps-scrollbar-y'></div>").appendTo(
					$scrollbarYRail,
				),
				scrollbarXActive,
				scrollbarYActive,
			...
			var updateContentScrollTop = function (currentTop, deltaY) {
				...
				var scrollTop = parseInt(
					(scrollbarYTop * (contentHeight - containerHeight)) /
						(containerHeight - scrollbarYHeight),
					10,
				);
			...
			var updateContentScrollLeft = function (currentLeft, deltaX) {
				...
				var scrollLeft = parseInt(
					(scrollbarXLeft * (contentWidth - containerWidth)) /
						(containerWidth - scrollbarXWidth),
					10,
				);
			...
			var updateBarSizeAndPosition = function () {
				containerWidth = settings.includePadding
					? $this.innerWidth()
					: $this.width();
				containerHeight = settings.includePadding
					? $this.innerHeight()
					: $this.height();
				...
				if (
					...
					scrollbarXWidth = getSettingsAdjustedThumbSize(
						parseInt((containerWidth * containerWidth) / contentWidth, 10),
					);
					scrollbarXLeft = parseInt(
						($this.scrollLeft() * (containerWidth - scrollbarXWidth)) /
				...
				if (
					...
					scrollbarYHeight = getSettingsAdjustedThumbSize(
						parseInt((containerHeight * containerHeight) / contentHeight, 10),
					);
					scrollbarYTop = parseInt(
						($this.scrollTop() * (containerHeight - scrollbarYHeight)) /
			...
			var bindMouseWheelHandler = function () {
				...
				$this.bind(
					...
					function (e, deprecatedDelta, deprecatedDeltaX, deprecatedDeltaY) {
						...
						if (!settings.useBothWheelAxes) {
							...
							$this.scrollLeft(
								$this.scrollLeft() + deltaX * settings.wheelSpeed,
							);
							...
							if (deltaY) {
								$this.scrollTop(
									$this.scrollTop() - deltaY * settings.wheelSpeed,
								);
							} else {
								$this.scrollTop(
									$this.scrollTop() + deltaX * settings.wheelSpeed,
								);
							}
							shouldPrevent = true;
							...
							if (deltaX) {
								...
								$this.scrollLeft(
									$this.scrollLeft() - deltaY * settings.wheelSpeed,
								);
							}
							shouldPrevent = true;
						}
			...
			var bindKeyboardHandler = function () {
				...
				$(document).bind("keydown" + eventClassName, function (e) {
					if (
						!hovered ||
						$(document.activeElement).is(":input,[contenteditable]")
					) {
						return;
					}
			...
			var bindRailClickHandler = function () {
				...
				$scrollbarYRail.bind("click" + eventClassName, function (e) {
					var halfOfScrollbarLength = parseInt(scrollbarYHeight / 2, 10),
						positionTop =
							e.pageY - $scrollbarYRail.offset().top - halfOfScrollbarLength,
				...
				$scrollbarXRail.bind("click" + eventClassName, function (e) {
					var halfOfScrollbarLength = parseInt(scrollbarXWidth / 2, 10),
						positionLeft =
							e.pageX - $scrollbarXRail.offset().left - halfOfScrollbarLength,
			...
			var initialize = function () {
				var ieMatch = navigator.userAgent
					.toLowerCase()
					.match(/(msie) ([\w.]+)/);
