            ...
            <div class="jobseeker-login">
                ...
                <form action="/remote/login" method="POST" class="navbar-form job-seeker" role="form"
                    ...
                    <p class="js-subHeading">
                        <strong>
                            Forgot your registered email? Simply click Register Now and create a new account. Access will be granted after review by our team within 3 business days.
                        </strong>
                    </p>
                </form>
            </div>
