							...
							<ul className="zc-chats-list">
								{chatsState.map((chat) => {
									...
									const dateStr = chat.messages?.length
										? format(
												new Date(chat.messages.at(-1)!.created_at),
												"MMM dd",
											)
										: "";
							...
							{activeChat ? (
												...
												<div key={group.date}>
													...
													{group.messages.map((msg) => {
														...
														return (
															<div
																key={msg.id}
																className={`chat-message my-3 ${isMe ? "me" : "other"}`}
															>
								...
								<div className="m-auto p-5 text-center">
									...
									<p className="text-muted">
										Connect with professionals and recruiters to grow your
										career through meaningful conversations.
									</p>
								</div>
							)}
						</div>
