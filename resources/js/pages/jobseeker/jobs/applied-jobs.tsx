...
const AppliedJobsListing = ( { initialJobs, pagination, applicationStatusOptions }: Props ) => {
    ...
    const handlePageChange = useCallback( ( page: number ) => {
        setLoading( true );
        router.get( "/jobseeker/jobs/your/applied/", { ...filtersRef.current, page }, {
            preserveState: true,
            preserveScroll: true,
            onFinish: () => setLoading( false ),
        } );
                                            ...
                                            <div className="zc-accordion-content" style={ { display: isStatusAccordionOpen ? 'block' : 'none' } }>
                                                <div className="jappli-status-filter">
                                                    { applicationStatusOptions.map( ( option ) => (
                                                        <div className="zc-field check-box-field" key={ option.value }>
                                                            <input
                                                                type="radio"
                                                            ...
                                                            />
                                                            <label htmlFor={ `jbappli-status-${ option.value }` } className='mb-0'>
                                                                { option.label }
                                                            </label>
                                                        </div>
                                                    ) ) }
                                                ...
                                                <div className="jappli-status-filter">
                                                    <div className="zc-field">
                                                        ...
                                                        <input
                                                            ...
                                                            onChange={ ( e ) => handleFilterChange( { after_date: e.target.value } ) }
                                                        />
                                                    </div>
                                                    <div className="zc-field">
                                                        <label>Before</label>
                                                        <input
                                                            ...
                                                            onChange={ ( e ) => handleFilterChange( { before_date: e.target.value } ) }
                                                        />
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div className='col-lg-8'>
                            <div className="zc-job-search-wrap zc-card mb-4">
                                ...
                                <div className="jobs-found">
                                    <p>Found { pagination.total } job{ pagination.total !== 1 ? 's' : '' }</p>
                                </div>
                            </div>
                            { loading ? (
