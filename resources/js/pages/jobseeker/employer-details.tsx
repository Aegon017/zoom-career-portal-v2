                ...
                <div className="zc-employer-profile-view-wrapper bg-white">
                    <div className="zc-employer-profile-view-top">
                        ...
                        <div className="zc-employer-profile-view-header d-block d-md-flex gap-3">
                            <div className="col-left mb-md-0 mb-2">
                                ...
                                <div className="top">
                                    ...
                                    <div className="right">
                                        <div className="btn-group">
                                            <FollowButton followableId={company.id} followableType="company" isFollowing={company.is_followed} />
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="zc-employer-profile-view-body d-block position-relative w-100 p-5">
                        <div className="zc-employer-overview zc-block mb-3">
