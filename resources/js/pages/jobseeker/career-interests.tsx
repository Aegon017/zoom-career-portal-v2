...
const CareerInterests: React.FC<Props> = ({
	years,
	months,
	industries,
	locations,
		...
		<AppLayout>
			...
			<div className="zc-container py-4">
				...
				<div className="p-md-5 mx-auto rounded bg-white p-3 shadow-sm">
					<h3 className="mb-2">
						Zoom Career wants to help you find the career and job that's right
						for you.
					</h3>
					<p className="border-bottom mb-4 pb-2">
						Tell us a little more about yourself and we'll recommend jobs that
									...
									<div className="d-flex flex-column gap-2">
										{employmentTypes.map((option) => (
											<div key={option.value} className="form-check">
												...
												/>
												<label
													htmlFor={`employment_${option.value}`}
