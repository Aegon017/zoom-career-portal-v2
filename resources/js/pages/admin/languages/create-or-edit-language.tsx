...
const CreateOrEditLanguage = ({
	...
	const onSubmit = (data: any) => {
		...
		const routes = {
			Create: () =>
				router.post("/admin/languages", data, { onError: handleErrors }),
			Edit: () =>
				router.put(`/admin/languages/${language.id}`, data, {
					...
					<form onSubmit={handleSubmit(onSubmit)} className="space-y-8 p-4">
						...
						<div className="flex gap-4">
							...
							<Button
								type="button"
								variant="outline"
								onClick={() => router.get("/admin/languages")}
							>
								Cancel
							</Button>
						</div>
