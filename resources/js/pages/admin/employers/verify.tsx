...
import type { BreadcrumbItem, Company, CompanyUser, Profile, User } from '@/types';
import { Head, router } from '@inertiajs/react';
import { Briefcase, Building2, CheckCircle, ExternalLink, Globe, Landmark, Mail, MapPin, Phone, Shield, User2, Users } from 'lucide-react';
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                <div className="mb-8">
                                    <div className="mb-2 flex items-center gap-3">
                                        ...
                                        <div>
                                            <h1 className="text-foreground text-3xl font-bold">Employer Verification</h1>
                                        ...
                                        <Card className="shadow-lg backdrop-blur-sm">
                                            ...
                                            <CardContent className="space-y-6">
                                                ...
                                                <div className="flex flex-col items-center space-y-4 text-center">
                                                    ...
                                                    <div>
                                                        <h3 className="text-foreground text-xl font-semibold">{user.name}</h3>
                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    {profile?.job_title && (
                                                        <div className="bg-muted flex items-center gap-3 rounded-lg p-3">
                                                            ...
                                                            <span className="text-foreground text-sm">{profile?.job_title}</span>
                                                        </div>
                                                    )}
                                                </div>
                                            </CardContent>
                                            ...
                                            <CardContent>
                                                ...
                                                <div className="mb-8 flex items-start gap-6">
                                                    ...
                                                    <div className="flex-1">
                                                        <h2 className="text-foreground mb-2 text-2xl font-bold">{company.name}</h2>
                                                        {company.description && (
                                                        ...
                                                        {company.industry && (
                                                            <div className="bg-muted border-muted/30 flex items-center gap-3 rounded-lg border p-3">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="text-foreground text-sm">{company.industry.name}</p>
                                                                </div>
                                                            </div>
                                                        )}
                                                        ...
                                                        {company.type && (
                                                            <div className="bg-muted border-muted/30 flex items-center gap-3 rounded-lg border p-3">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="text-foreground text-sm">{company.type}</p>
                                                                </div>
                                                            </div>
                                                        )}
                                                        ...
                                                        {company.size && (
                                                            <div className="bg-muted border-muted/30 flex items-center gap-3 rounded-lg border p-3">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="text-foreground text-sm">{company.size}</p>
                                                                </div>
                                                            </div>
                                                        )}
                                                    </div>
                                                    ...
                                                    <div className="space-y-4">
                                                        ...
                                                        <div className="bg-muted border-muted/30 flex items-start gap-3 rounded-lg border p-3">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-foreground text-sm leading-relaxed">{company.email}</p>
                                                            </div>
                                                        </div>
                                                        <div className="bg-muted border-muted/30 flex items-start gap-3 rounded-lg border p-3">
                                                            <MapPin className="text-muted-foreground mt-0.5 h-4 w-4 flex-shrink-0" />
                                                            <div>
                                                                ...
                                                                <p className="text-foreground text-sm leading-relaxed">{company.phone}</p>
                                                            </div>
                                                        </div>
                                                        {company.address && (
                                                            <div className="bg-muted border-muted/30 flex items-start gap-3 rounded-lg border p-3">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="text-foreground text-sm leading-relaxed">
                                                                        {company.address.location.city}, {company.address.location.state},{' '}
