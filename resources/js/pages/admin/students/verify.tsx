		...
		<AppLayout>
			...
			<div className="mx-auto max-w-4xl px-4 py-10">
				...
				<p className="mb-6 text-gray-600">
					Please review the submitted details before approving or rejecting this
				...
				<div className="grid grid-cols-1 gap-6 text-sm sm:grid-cols-2">
					...
					<div>
						...
						<p className="text-base text-gray-900">
							{student.profile.course_completed}
						</p>
					</div>
					<div>
					...
					<div>
						...
						<p className="text-base text-gray-900">
							{student.profile.completed_month}
						</p>
					</div>
					<div>
						<p className="font-medium text-gray-500">Verification Status</p>
						<Badge
							variant={student.profile.is_verified ? "outline" : "default"}
						>
