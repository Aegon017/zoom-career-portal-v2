			...
			<div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
				<DataTable
					...
					exportFields={[
						...
						{
							key: "personal_detail.marital_status",
							label: "Marital Status",
							selected: true,
						},
						{
							key: "personal_detail.date_of_birth",
							label: "Date of Birth",
							selected: true,
						},
						{
							key: "personal_detail.differently_abled",
							label: "Differently Abled",
							selected: false,
						},
						{
							key: "address.location_id",
						...
						{
							key: "work_experiences.title",
							label: "Job Title (Work)",
							selected: true,
						},
						{
							key: "work_experiences.company_name",
							label: "Company Name",
							selected: true,
						},
						{
							key: "work_experiences.start_date",
							label: "Employment Start Date",
							selected: true,
						},
						{
							key: "work_experiences.end_date",
							label: "Employment End Date",
							selected: true,
						},
						{
							key: "work_experiences.is_current",
						...
						{
							key: "educations.course_title",
							label: "Course Title",
							selected: true,
						},
						{
							key: "educations.institution",
							label: "Institution",
							selected: true,
						},
						{
							key: "educations.course_type",
							label: "Course Type",
							selected: true,
						},
						{
							key: "educations.start_date",
							label: "Education Start Date",
							selected: true,
						},
						{
							key: "educations.end_date",
							label: "Education End Date",
							selected: true,
						},
						{
							key: "educations.is_current",
						...
						{
							key: "user_languages.language_id",
							label: "Language",
							selected: true,
						},
						{
							key: "user_languages.proficiency",
							label: "Proficiency Level",
							selected: true,
						},
						{
							key: "user_languages.can_read",
							label: "Can Read",
							selected: false,
						},
						{
							key: "user_languages.can_write",
							label: "Can Write",
							selected: false,
						},
						{
							key: "user_languages.can_speak",
							label: "Can Speak",
							selected: false,
						},
