...
const CreateOrEditStudent = ({
	...
	const onSubmit = (data: FormValues) => {
		...
		const formattedData = {
			...
			work_experiences: data.work_experiences?.map((we) => ({
				...
				start_date: we.start_date
					? we.start_date.toISOString().split("T")[0]
					: undefined,
				end_date: we.end_date
					? we.end_date.toISOString().split("T")[0]
					: undefined,
			})),
		...
		const routes = {
			Create: () =>
				router.post("/admin/students", formattedData, {
					onError: handleErrors,
				}),
			Edit: () =>
				router.put(`/admin/students/${student.id}`, formattedData, {
					onError: handleErrors,
				}),
		};
													...
													<FormItem>
														...
														<FormControl>
															<Input
																...
																autoComplete="email"
																data-error={
																	hasFieldError("email") ? "true" : "false"
																}
															/>
														</FormControl>
														<FormMessage />
													...
													<FormItem>
														...
														<FormControl>
															<PhoneInput
																...
																{...field}
																data-error={
																	hasFieldError("phone") ? "true" : "false"
																}
															/>
														</FormControl>
														<FormMessage />
													...
													<FormItem>
														...
														<FormControl>
															<Input
																...
																{...field}
																data-error={
																	hasFieldError("password") ? "true" : "false"
																}
															/>
														</FormControl>
														<FormMessage />
								...
								<Card className="p-4 sm:p-6">
									...
									<div className="grid md:grid-cols-2 gap-4">
												...
												<FormItem>
													...
													<FormControl>
														...
														>
															<SelectTrigger
																data-error={
																	hasFieldError("personal_detail.gender")
																		? "true"
																		: "false"
																}
															>
												...
												<FormItem>
													...
													<FormControl>
														...
														>
															...
															<SelectContent>
																<SelectItem value="Single/unmarried">
																	Single/unmarried
																</SelectItem>
												...
												<FormItem className="flex flex-row items-center gap-2">
													<FormControl>
														<Checkbox
															...
															data-error={
																hasFieldError(
																	"personal_detail.differently_abled",
																)
																	? "true"
																	: "false"
															}
										...
										<SelectPopoverField
											...
											data-error={
												hasFieldError("address.location_id") ? "true" : "false"
											}
										/>
									</div>
								</Card>
												...
												<FormItem>
													...
													<FormControl>
														<Input
															...
															{...field}
															data-error={
																hasFieldError("profile.experience")
																	? "true"
																	: "false"
															}
														/>
												...
												<FormItem>
													...
													<FormControl>
														<Input
															...
															{...field}
															data-error={
																hasFieldError("profile.notice_period")
																	? "true"
																	: "false"
															}
														/>
												...
												<FormItem>
													...
													<FormControl>
														<Input
															...
															{...field}
															data-error={
																hasFieldError("profile.job_title")
																	? "true"
																	: "false"
															}
														/>
											...
											<FormItem>
												...
												<FormControl>
													<MultipleSelector
														...
														data-error={
															hasFieldError("skills") ? "true" : "false"
														}
													/>
												</FormControl>
												<FormMessage />
														...
														<FormItem>
															...
															<FormControl>
																<Input
																	{...field}
																	data-error={
																		hasFieldError(`certificates.${index}.name`)
																			? "true"
																			: "false"
																	}
																/>
																...
																<FormControl>
																	...
																	>
																		<SelectTrigger
																			data-error={
																				hasFieldError(
																					`user_languages.${index}.language_id`,
																				)
																					? "true"
																					: "false"
																			}
																...
																<FormControl>
																	...
																	>
																		<SelectTrigger
																			data-error={
																				hasFieldError(
																					`user_languages.${index}.proficiency`,
																				)
																					? "true"
																					: "false"
																			}
																	...
																	<FormItem className="flex flex-row items-start space-x-3 space-y-0">
																		<FormControl>
																			<Checkbox
																				...
																				data-error={
																					hasFieldError(
																						`user_languages.${index}.can_write`,
																					)
																						? "true"
																						: "false"
																				}
																	...
																	<FormItem className="flex flex-row items-start space-x-3 space-y-0">
																		<FormControl>
																			<Checkbox
																				...
																				data-error={
																					hasFieldError(
																						`user_languages.${index}.can_speak`,
																					)
																						? "true"
																						: "false"
																				}
									...
									<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
										<div>
											...
											<p>
												...
												{form.watch("password") ? "Set" : "Not Set"}
											</p>
										</div>
										<div>
											...
											<p>
												...
												{form.watch("personal_detail.gender")}
											</p>
											<p>
												<strong>Marital Status:</strong>{" "}
												{form.watch("personal_detail.marital_status")}
											</p>
											<p>
												<strong>Date of Birth:</strong>{" "}
												{formatDateSafely(
													form.watch("personal_detail.date_of_birth"),
												)}
											</p>
											<p>
												<strong>Differently Abled:</strong>{" "}
												{form.watch("personal_detail.differently_abled")
													? "Yes"
													: "No"}
											</p>
											<p>
												<strong>Address:</strong>{" "}
												{form.watch("address.location_id")
													? locationOptions.find(
															(loc) =>
																loc.value === form.watch("address.location_id"),
														)?.label
													: "N/A"}
											</p>
										</div>
										<div>
											...
											<p>
												...
												{form.watch("profile.job_title")}
											</p>
											<p>
												<strong>Experience:</strong>{" "}
												{form.watch("profile.experience")}
											</p>
											<p>
												<strong>Notice Period:</strong>{" "}
												{form.watch("profile.notice_period")}
											</p>
											<p>
												<strong>Summary:</strong>{" "}
												{form.watch("profile.summary")}
											</p>
										</div>
										<div>
											...
											<p>
												{form
													...
													.map(
														(skill) =>
															skillOptions.find((opt) => opt.value === skill)
																?.label,
													)
													.join(", ")}
											</p>
											...
											{workExperienceFields.fields.map((we, index) => (
												...
												>
													<p>
														...
														{form.watch(`work_experiences.${index}.title`)} at{" "}
														{form.watch(
															`work_experiences.${index}.company_name`,
														)}
													</p>
													...
													<p>
														End:{" "}
														{formatDateSafely(
															form.watch(`work_experiences.${index}.end_date`),
														)}
													</p>
													<p>
														Current:{" "}
														{form.watch(`work_experiences.${index}.is_current`)
															? "Yes"
															: "No"}
													</p>
												</div>
											...
											{educationFields.fields.map((edu, index) => (
												...
												>
													<p>
														...
														{form.watch(`educations.${index}.course_title`)} at{" "}
														{form.watch(`educations.${index}.institution`)}
													</p>
													<p>
														Course Type:{" "}
														{form.watch(`educations.${index}.course_type`)}
													</p>
													<p>
														Start:{" "}
														{formatDateSafely(
															form.watch(`educations.${index}.start_date`),
														)}
													</p>
													<p>
														End:{" "}
														{formatDateSafely(
															form.watch(`educations.${index}.end_date`),
														)}
													</p>
													<p>
														Current:{" "}
														{form.watch(`educations.${index}.is_current`)
															? "Yes"
															: "No"}
													</p>
												</div>
											...
											{languageFields.fields.map((lang, index) => (
												...
												>
													<p>
														...
														- Proficiency:{" "}
														{form.watch(`user_languages.${index}.proficiency`)}
													</p>
													<p>
														Can Read:{" "}
														{form.watch(`user_languages.${index}.can_read`)
															? "Yes"
															: "No"}
													</p>
													<p>
														Can Write:{" "}
														{form.watch(`user_languages.${index}.can_write`)
															? "Yes"
															: "No"}
													</p>
													<p>
														Can Speak:{" "}
														{form.watch(`user_languages.${index}.can_speak`)
															? "Yes"
															: "No"}
													</p>
												</div>
