                ...
                <div className="w-full max-w-lg space-y-6 rounded-xl border border-gray-200 bg-white p-8 text-center shadow-xl md:p-10">
                    <div className="space-y-3">
                        ...
                        <p className="text-gray-700">
                            Thank you for registering! Your account is currently under review by our administrators. Once your details are verified,
                            you’ll be able to access job opportunities in the portal.
                        </p>
                        <p className="text-muted-foreground text-sm">
                            This process might take a little time. We appreciate your patience. If you’ve already been verified, you can proceed to
