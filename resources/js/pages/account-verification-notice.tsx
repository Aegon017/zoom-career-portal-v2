        ...
        <div className="bg-muted flex min-h-screen items-center justify-center px-4">
            ...
            <Card className="w-full max-w-md">
                <CardHeader className="flex flex-col items-center space-y-2 text-center">
                    ...
                    <CardTitle className="text-xl font-semibold">Account Not Verified</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4 text-center">
                    <p className="text-muted-foreground">Your account is pending verification by the administrator.</p>
                    <p className="text-muted-foreground">Please contact the admin to verify and activate your account.</p>
