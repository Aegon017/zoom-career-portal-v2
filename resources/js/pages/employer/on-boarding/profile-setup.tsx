        ...
        <>
            ...
            <div className="flex flex-1 justify-center p-8">
                <div className="w-full max-w-xl">
                    <h1 className="text-center text-3xl font-bold">Complete your profile, {user.name}</h1>
                                        ...
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <FileUpload
                                                    ...
                                                    name="file"
                                                    onUploaded={(tempPath) => setValue('avatar', tempPath)}
                                                />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <PhoneInput type="tel" placeholder="Enter your phone number" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
