                ...
                <div className="flex min-h-screen flex-col items-center justify-center px-6 py-16">
                    <div className="w-full max-w-4xl space-y-12 text-center">
                        ...
                        <div className="relative mx-auto h-32 w-32">
                            ...
                            <div className="border-muted absolute inset-0 animate-spin rounded-full border-4" style={{ animationDuration: '3s' }} />
                            <div
                        ...
                        <div className="space-y-6">
                            <div className="space-y-4">
                                <h1 className="text-foreground text-4xl leading-tight font-bold md:text-5xl">Request Under Review</h1>
                                ...
                                <CardContent className="p-8 md:p-10">
                                    <div className="mb-6 flex items-center gap-6">
                                        ...
                                        <div className="text-left">
                                            <h2 className="text-card-foreground mb-1 text-2xl font-bold">{company.name}</h2>
                            ...
                            <Card className="border-emerald-200 bg-emerald-50 shadow-lg dark:border-emerald-800 dark:bg-emerald-950/50">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4 text-left">
                                        ...
                                        <div>
                                            <h3 className="mb-2 text-lg font-bold text-emerald-900 dark:text-emerald-100">What happens next?</h3>
                            ...
                            <Card className="border-amber-200 bg-amber-50 shadow-lg dark:border-amber-800 dark:bg-amber-950/50">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4 text-left">
                                        ...
                                        <div>
                                            <h3 className="mb-2 text-lg font-bold text-amber-900 dark:text-amber-100">Review Timeline</h3>
                        ...
                        <div className="flex items-center justify-center space-x-4 pt-8">
                            <div className="flex space-x-3">
                                ...
                                <div className="bg-primary/70 h-3 w-3 animate-pulse rounded-full" style={{ animationDelay: '0.2s' }} />
                                <div className="bg-primary/40 h-3 w-3 animate-pulse rounded-full" style={{ animationDelay: '0.4s' }} />
                            </div>
                            <span className="text-muted-foreground text-base font-medium">Processing your request</span>
                        </div>
                    </div>
                </div>
            </div>
