	...
	return (
		<AppLayout breadcrumbs={breadcrumbs}>
			...
			<div className="bg-background flex h-[calc(100vh-80px)] overflow-hidden">
				<div
					className={`flex flex-col border-r bg-white ${activeChat ? "hidden" : "flex"} w-full lg:flex lg:w-1/3`}
				>
					...
					<ScrollArea>
						<div className="space-y-1 p-2">
							{chatsState.map((chat) => {
								...
								const last =
									chat.messages?.at(-1)?.message || "No messages yet";
								...
								return (
									...
									>
										...
										<div className="min-w-0 flex-1">
											...
											<div
												className="text-muted-foreground line-clamp-1 truncate text-sm text-wrap"
								...
								<DropdownMenu>
									...
									<DropdownMenuContent align="end">
										<DropdownMenuItem>
											<Link
												className="flex"
												href={`/employer/jobseekers/${getOtherParticipant(activeChat)?.id}`}
											>
								...
								<div className="relative flex items-end gap-2">
									<div className="relative flex-1">
										<div className="relative">
											...
											/>
											{message.trim() === "" && (
												<div className="pointer-events-none absolute inset-0 p-3 text-gray-500">
													Type a message...
												</div>
											)}
										</div>
