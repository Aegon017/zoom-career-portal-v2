			...
			<div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
				<div className="max-w-2xl mx-auto space-y-6 p-6 border rounded-xl shadow-md bg-white">
					...
					<p className="mt-2 text-center text-sm text-gray-500">
						Please share your thoughts, suggestions, or feedback about your
						experience using our job board.
					</p>

					<div className="space-y-2">
						<label className="font-medium text-sm text-gray-700">
							1. How was your overall experience with the portal and the
							candidates?
						</label>
						<Textarea
							rows={6}
					...
					<div className="space-y-2">
						<label className="font-medium text-sm text-gray-700">
							2. Were you able to find suitable candidates for your
							requirements?
						</label>
						<Textarea
							rows={4}
