...
export default function Certifications({ isUpdatable, user }: Props) {
    ...
    const onSubmit = (data: CertificateFormData) => {
        ...
        router.post(
            '/jobseeker/profile/certificates',
            {
        ...
        <>
            ...
            <PopupModal title="Edit Certifications" isActive={activeModal} onClose={closeModal} onSave={handleSubmit(onSubmit)}>
                    ...
                    {fields.map((field, index) => (
                        <div key={field.id} className="border-bottom mb-4 pb-3">
                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    <input type="text" {...field} className="form-control" placeholder="Enter certification name" />
                                )}
                            />
              ...
              /> */}
                    ...
                    <button type="button" className="btn btn-primary" onClick={() => append({ name: '' })}>
                        Add Certification
                    </button>
                </div>
            </PopupModal>
