...
const ProfileModal: React.FC<ProfileModalProps> = ({ isActive, handleClose, user }) => {
    ...
    return (
        <PopupModal isActive={isActive} title="Profile Summary" onClose={handleClose} onSave={handleSubmit(onSubmit)}>
            <div className="modal-body overflow-auto" style={{ maxHeight: '400px' }}>
                ...
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" {...register('job_title')} />
                ...
                <div className="mb-3">
                    ...
                    <Select
                        ...
                        defaultValue={
                            defaultLocation ||
                            (user.address?.location?.city ? { label: user.address.location.city, value: user.address.location.city } : null)
                        }
                ...
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" {...register('experience')} />
                </div>
                ...
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" {...register('notice_period')} />
                </div>
            </div>
        </PopupModal>
    );
