...
const SkillsModal: React.FC<SkillsModalProps> = ({ isActive, handleClose, user }) => {
    ...
    useEffect(() => {
        const timeout = setTimeout(() => {
            axios.get('/skills/search', { params: { search: skillSearch } }).then((res) => {
    ...
    return (
        <PopupModal title="Key Skills" isActive={isActive} onClose={handleClose} onSave={handleSubmit(onSubmit)}>
