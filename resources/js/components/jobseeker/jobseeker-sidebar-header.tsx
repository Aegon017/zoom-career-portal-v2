...
export function AppSidebarHeader({
	...
	return (
		<div className="zc-main-top-nav">
			<button
				className="zc-sidebar-toggle"
				id="zc-sidebar-toggle"
				ref={sidebarToggle.toggleRef}
				onClick={() => sidebarToggle.toggle()}
			>
				<i className="fa-solid fa-bars"></i>
			</button>
			<Link href="/jobseeker/dashboard" className="brand-logo">
				<img src="/logo.png" alt="Zoom Career" />
			</Link>
			<ul className="zc-top-nav-bar">
				<li
					className="zc-nav-item zc-dropdown user-notification"
					ref={notificationNav.dropdownRef}
				>
					<button
				...
				<li
					className="zc-nav-item zc-dropdown user-nav"
					ref={userNav.dropdownRef}
				>
					<button
						className="zc-dropdown-btn"
						onClick={() => {
