			...
			<div className="top">
				<div className="first-block mb-2">
					...
					<div className="company-info">
						...
						{opening.address && (
							<p className="mb-0">
								{opening.address?.location?.city},{" "}
								{opening.address?.location?.country}
							</p>
						)}
					</div>
				</div>
				<div className="second-block">
					<div className="job-application-status mb-1">
						{opening.application_status}
					</div>
					<p className="applied-date mb-0">
						Applied:{" "}
						{formatDistanceToNow(new Date(opening.application_created_at))} ago
					</p>
				</div>
			</div>
			<div className="bottom">
				<div className="first-block mb-sm-2 mb-md-0">
					<p
						...
						dangerouslySetInnerHTML={{ __html: opening.description }}
					></p>
				</div>
				<div className="second-block">
