            ...
            <div className="px-8">
                    ...
                    { company.logo_url && (
                        <div className="flex-shrink-0">
                            <img
                                ...
                                alt="Company Logo"
                                className="h-20 w-20 rounded-xl border bg-primary object-contain p-2 shadow-sm"
                            />
                        </div>
                    ) }
                    <div className="flex-1">
                        <h2 className="text-foreground mb-2 text-2xl font-bold break-words">
                            { company.name }
                        </h2>
                        { company.description && (
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div className="bg-muted border-muted/30 flex items-start gap-3 rounded-lg border p-3">
                            ...
                            <div>
                                ...
                                <p className="text-foreground text-sm leading-relaxed break-words">
                                    { company.address.location.full_name }
                                </p>
                            </div>
                        </div>
                    ) }
                    ...
                    { company.verification_status && (
                        <div className="bg-muted border-muted/30 flex items-center gap-3 rounded-lg border p-3">
                            <CheckCircle className="text-muted-foreground h-4 w-4 flex-shrink-0" />
                            <div>
                                <p className="text-muted-foreground text-xs font-medium">Verification</p>
                                <p className="text-foreground text-sm break-words">
