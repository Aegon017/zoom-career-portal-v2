...
!(function (t, e) {
    ...
    (B.on(document, 'click.bs.collapse.data-api', '[data-bs-toggle="collapse"]', function (t) {
        ...
        i.find(s).forEach((t) => {
            ...
            let i;
            (s
                ? (null === s._parent && 'string' == typeof e.parent && ((s._config.parent = e.parent), (s._parent = s._getParent())), (i = 'toggle'))
                : (i = e),
    ...
    class jt extends q {
        ...
        setElementContent(t, e) {
            if (null !== t)
                return c(e)
                    ? ((e = h(e)),
                      void (this._config.html ? e.parentNode !== t && ((t.innerHTML = ''), t.appendChild(e)) : (t.textContent = e.textContent)))
                    : void (this._config.html
                          ? (this._config.sanitize && (e = Dt(e, this._config.allowList, this._config.sanitizeFn)), (t.innerHTML = e))
                          : (t.textContent = e));
        }
        getTitle() {
    ...
    class Ft extends q {
        ...
        _getConfig(t) {
            if (
                'string' != typeof (t = { ...qt, ...V.getDataAttributes(this._element), ...('object' == typeof t && t ? t : {}) }).target &&
                c(t.target)
            ) {
                let { id: e } = t.target;
